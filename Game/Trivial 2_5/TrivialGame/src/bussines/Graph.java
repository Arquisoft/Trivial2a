...
public class Graph<T> {
	 ...
	 * 
	 * @param size
	 *            numero maximo de nodos que puede tener el grafo
	 */
	 ...
	 * @return int, Devuelve 0 cuando puede añadir el nodo y -1 si no lo ha
	 *         añadido
	 */
	 ...
	 * 
	 * @param node
	 *            nodo del cual queremos saber la posicion
	 * @return int, Si el nodo no existe va a devolver -1, en caso contrario
	 ...
	 * 
	 * @param node
	 *            nodo que se quiere saber si existe.
	 * @return boolean, Devuelve true si existe un nodo y false en caso
	 *         contrario
	 */
	...
	/**
	 * Método auxiliar que genera la matriz de costes en el algoritmo de
	 * Djikstra
	 * 
	 * @param node
	 *            , nodo origen por donde empieza el algoritmo
	 ...
	 * 
	 * @param node
	 *            , nodo de origen del algoritmo
	 * @return p, matriz de nodos por los que se puede acceder desde el nodo
	 *         Origen
	 */
	 ...
	 * 
	 * @param source
	 *            nodo origen del vertice
	 * @param target
	 *            nodo destino del vertice
	 * @param w
	 *            peso de la arista.
	 * @return int, Devuelve 0 si consigue insertar la arista y -1 en caso
	 *         contrario
	 */
	...
	/**
	 * Algoritmo de floyd-warshall que devuelve al amatriz de caminos Inicializa
	 * la matriz A(coste) con el peso de las aristas, y 0 en la diagonal
	 * 
	 * @return double[][] a, matriz que te indica entre que dos nodos hay camino
	 *         pasando por un nodo intermedio señanalndolos con el indice del
	 *         nodo intermedio y el resto de posiciones con -1.
	 */
	public double[][] floyd() {
	...
	/**
	 * Método auxiliar que inicializa la matriz de costes para el algoritmo de
	 * Floyd.
	 * 
	...
	/**
	 * Método auxiliar que inicializa la matriz de arcos para el algoritmo de
	 * Floyd.
	 * 
	...
	/**
	 * Metodo que intenta recorrer, a partir del nodo que le pasas, el grafo
	 * completo.
	 * 
	 * @param nodo
	 *            nodo de origen para intentar recorrer todos los demas
	 * @return int, 0 si recorre todos los nodos del grafo y -1 si no puede
	 *         recorrerlos todos.
	 */
	...
	/**
	 * Metodo recursivo que va recorriendo los nodos hasta que los recorre
	 * todos. Al modificar el vector se modifica fuera
	 * 
	 * @param source
	 *            nodo desde el que se va a intentar recorrer todos los nodos.
	 * @param visitados
	 *            , array que indica que nodos han sido visitados y cuales no,
	 */
	 ...
	 * 
	 * @param visited
	 *            array booleano que indica qué nodos han sido visitados
	 * @return -1 si queda alguno que no ha sido visitado, 0 si están todos
	 *         visitados.
	 */
