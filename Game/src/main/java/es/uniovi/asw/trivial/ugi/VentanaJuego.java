...
public class VentanaJuego extends JDialog {
	...
	/**
	 * Clase en la que se muestra el tablero en el centro
	 * En el lateral izquiero hay un panel con los jugadores 1-5-3
	 * En el panel del lateral derecho estarían los jugadores 2-6-4
	 * Cana uno de estos paneles es de tipo "PanelJugador"
	 */
	private static final long serialVersionUID = 1L;

	private final JPanel contentPanel;
	private JPanelBackgroundImage pnBoard;
	...
	private JPanel getPnBoard() {
		if (pnBoard == null) {
			pnBoard = new JPanelBackgroundImage(new ImageIcon(VentanaJuego.class.getResource("/images/gameboard.jpg")).getImage());
			pnBoard.setBounds(146, 0, 458, 458);
	...
	private JPanel crearPanel(int i){
		return (game.getUserList().size()>=i)?new PanelJugador(game.getUserList().get(i)): new JPanel();
	}
