...
public class PanelJugador extends JPanel {
	...
	private JLabel getLblSports() {
		if (lblSports == null) {
			...
			lblSports.setIcon(new ImageIcon(
					"resources/images/images/sports.png"));
		}
		return lblSports;
	}
	...
	private JLabel getLblScience() {
		if (lblScience == null) {
			...
			lblScience.setIcon(new ImageIcon(
					"resources/images/images/science.png"));
		}
		return lblScience;
	}
	...
	private JLabel getLblHistory() {
		if (lblHistory == null) {
			...
			lblHistory.setIcon(new ImageIcon(
					"resources/images/images/history.png"));
		}
		return lblHistory;
	}
	...
	public void refreshScore() throws IllegalActionException {
		...
		boolean[] quesitos = { s.isSports(), s.isScienceAndTechnology(),
				s.isHistory(), s.isShowsAndEntertainment(),
				s.isArtAndLiterature(), s.isGeography() };
		int i = 0;
