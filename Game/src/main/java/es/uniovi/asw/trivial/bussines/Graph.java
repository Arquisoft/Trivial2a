...
public class Graph<T> {
	...
	private int size;//tama�o del grafo
	...
	/**
	 * Metodo que a�ade un nodo al grafo
	 * @param  node nodo que se quiere a�adir
	 * @return int, Devuelve 0 cuando puede a�adir el nodo y -1 si no lo ha a�adido
	 */
	...
	/**
	 * M�todo que devuelve el tama�o del grafo
	 * @return size, tama�o del grafo.
	 */
	public int getSize(){
		return size;
	}
	...
	/**
	 * Mira si existe una arista entre dos nodos que se pasan como par�metro
	 * @param source nodo origen
	 * @param target nodo destino
	 * @return verdadero o falso si existe o no, si alguno de los nodos no existe tambi�n falso
	 */
	...
	/**
	 * M�todo auxiliar que genera la matriz de costes en el algoritmo de Djikstra
...
/**
 * M�todo auxiliar para inicializar la matriz de nodos  por los que hay union directa con el nodo origen en Djikstra
...
/**
 * m�todo recursivo de djisktra que va escogiendo el arco de coste minimo posible en cada accion recursiva
...
/**
 * Devuelve el indice dentro del vector de distancias que sea mas peque�o y que no 
 ...
 * se�analndolos con el indice del nodo intermedio y el resto de posiciones con -1.
 */
public double[][] floyd(){
...
/**
 * M�todo auxiliar que inicializa la matriz de costes para el algoritmo de Floyd.
...
/**
 * M�todo auxiliar que inicializa la matriz de arcos para el algoritmo de Floyd.
...
/**
 * M�todo auxiliar que comprueba que todos los nodos hayan sido visitados
 * @param visited array booleano que indica cuales nodos han sido visitados
 * @return -1 si queda alguno que no ha sido visitado, 0 si est�n todos visitados.
 */
